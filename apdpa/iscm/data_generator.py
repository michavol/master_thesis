...
def generate_data_raw(graph: Graph, do_interventions: Dict[int, float], noise_vars: Dict[int, float], num_samples: int, mechanism: Callable,
    ...
    for node in sorted_nodes:
        if do_interventions is not None:
            if node in do_interventions:
                generated = np.full(num_samples, do_interventions[node])
...
def generate_data_alternate_standardization(graph: Graph, do_interventions: Dict[int, float], noise_vars: Dict[int, float], num_samples: int,
                                            mechanism: Callable, rng: Optional[np.random.Generator] = None,
                                            return_prestand_variances: bool = False, noise_dist=GAUSSIAN):
...
# SPECIFIC MECHANISMS
###################################################################
def generate_linear_data_raw(graph: Graph, do_interventions: Dict[int, float], noise_vars: Dict[int, float], num_samples: int,
                             rng: Optional[np.random.Generator] = None, noise_dist=GAUSSIAN):
    return generate_data_raw(graph=graph, do_interventions=do_interventions, noise_vars=noise_vars, num_samples=num_samples, mechanism=linear_mechanism,
                             rng=rng, noise_dist=noise_dist)


def generate_linear_data_alternate_standardization(graph: Graph, do_interventions: Dict[int, float], noise_vars: Dict[int, float], num_samples: int,
                                                   rng: Optional[np.random.Generator] = None,
                                                   return_prestand_variances: bool = False, noise_dist=GAUSSIAN):
    return generate_data_alternate_standardization(graph=graph, do_interventions=do_interventions, noise_vars=noise_vars, num_samples=num_samples,
